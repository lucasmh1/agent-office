...
const OFFLINE_TEMPLATES = {
  coder: [
    { text: 'Here is a clean prototype outline. Add a Gemini API key in Settings for full HTML generation.', html: null }
  ],
  creative: [
    { text: 'Art direction: void #0d0f14, violet #7c5cfc, cyan #22d3ee. Mood: neon nostalgia.', html: null }
  ],
  analyst: [
    { text: 'Trend: multi-agent orchestration is heating up. Ship collab flow first.', html: null }
  ],
  chaotic: [
    { text: 'What if the bug is the feature?', html: null }
  ],
  executive: [
    { text: 'Status green. Prototype ready for review.', html: null }
  ],
  support: [
    { text: 'Edges cleaned. Experience should feel approachable.', html: null }
  ]
};
